...
UTILPATH = os.path.dirname(UTILPATH)
UTILPATH = os.path.join(UTILPATH, 'backend', 'utils')
...
if __name__ == "__main__":
    folder_path = os.path.join(BASEPATH, 'data')
    ...
    asyncio.run(
        scrape_new_async(batch_size=5, output_path=outputfile, start_doc_id=start_doc_id, debug=False)
    )